...
def main():
    ...
    parser.add_argument('--rollout', help='rollout nas')
    parser.add_argument('--is_gpt', default = True, help='is the rollout given by gpt')
    ...
    if args.model == 'VGG8':
        ...
        modelCF = nas_utils.get_model_from_rollout(args.rollout, args, logger)
